...
The Maven artifact coordinates (`com.google.cloud:google-cloud-gke-connect-gateway`) remain the same.
...
```Groovy
implementation 'com.google.cloud:google-cloud-gke-connect-gateway:0.11.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-gke-connect-gateway" % "0.11.0"
```
